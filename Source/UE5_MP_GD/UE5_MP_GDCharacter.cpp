...
AUE5_MP_GDCharacter::AUE5_MP_GDCharacter()
{
...
void AUE5_MP_GDCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUE5_MP_GDCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUE5_MP_GDCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUE5_MP_GDCharacter::Look);
	}
	else
	{
...
void AUE5_MP_GDCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE5_MP_GDCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
